<template>
  <q-card flat class="q-pa-sm">
      ...
      <div class="q-pa-sm" style="width: 100%; display: flex; flex-direction: column; justify-content: flex-start">
        <div class="row">
          ...
          <div class="column" style="width: 50%">
            <div>
              <p>Type</p>
              <div class="inputBackground selectBackground"
                   style="width: 90%; display: flex; flex-direction: row; align-items: center">
                <select class="selectBackground"
                        style="width: 100%"
    ...
    <q-card-section class="cardSection q-pa-sm">
      ...
      <div>
        <q-btn-toggle v-model="backgroundType"
