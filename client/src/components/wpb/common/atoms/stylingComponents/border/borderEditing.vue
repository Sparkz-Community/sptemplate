<template>
  <div class="borderEditContainer q-pa-xs" :style="positionStyles">
    ...
    <div style="display: flex;justify-content: flex-end;">
      <q-btn @click="$emit('close')" round icon="close" color="red" size="sm"
             style="position: absolute;top: -10px;"></q-btn>
    </div>
    <div>
      <div style="display: flex; justify-content: flex-start;">
        <div class="flex items-center">
          ...
          <transition name="slide-fade">
            <div
              style="width: 100%; display: flex;flex-direction: row;position: absolute;top: 0;left: -25px;z-index: 100;"
              v-if="changeColor">
      ...
      <div style="display: flex; justify-content: flex-start;align-items: center;" class="q-mt-sm">
        ...
        <div class="inputBackground"
             style="width: 40px; display: flex; flex-direction: row; align-items: center;height: 20px;">
      ...
      <div class="row q-mt-sm">
        ...
        <div class="inputBackground" style="display: flex; flex-direction: row; align-items: center;">
          <select :value="elementBorderProperties.split(' ')[1]"
      ...
      updateBorder(value) {
        ...
        if (this.value === 'none') {
          ...
          this.$emit('changeColor', {
            path: `styles.border-${this.position}`,
            value: `${NumberValue} ${styleValue} ${this.setColor}`,
          });
        }
