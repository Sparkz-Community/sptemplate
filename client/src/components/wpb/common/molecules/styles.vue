...
<script>
  ...
  import IconEditor from '../atoms/stylingComponents/iconEditor';
  import Background from 'components/wpb/stylingComponents/background';
  import hyperLinkSettings from '../atoms/stylingComponents/hyperLinkSettings';
  import mapSettings from '../atoms/stylingComponents/mapSettings';
  import youtubeVideoSettings from '../atoms/stylingComponents/youtubeVideoSettings';
