...
<script>
  ...
  import styles from 'components/wpb/common/molecules/styles';
  import sectionView from 'components/wpb/common/substance/Section';
  import CssEditor from 'components/wpb/common/molecules/CSSEditor';
  ...
  import AutoSave from 'components/wpb/AutoSave/AutoSave';
  import ElementTemplates from 'components/wpb/elementTemplates/elementTemplates';
  import UserTemplates from 'components/wpb/userTemplates/userTemplates';
